...
from app.services import delegation_service, leave_balance_service, permissions, restriction_settings_service
...
def get_my_balance(
    ...
    return leave_balance_service.get_summary(db, subject, resolved_year)

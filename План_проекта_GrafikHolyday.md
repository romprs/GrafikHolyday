...
- **Синхронизация недоступных периодов с 1С не работает** — пользователь сообщил, логов не было (Phase 6.14 добавил логирование запроса/ответа и полный traceback на ошибках обработки), но сама причина сбоя ещё не диагностирована. Ждём вывод логов бэкенда после следующего запуска синка со вкладки «Интеграции».
